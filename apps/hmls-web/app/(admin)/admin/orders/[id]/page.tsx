...
export default function OrderDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Title row — lifecycle actions live here (above the tabs), so the
          operator can act from any tab without a dedicated sidebar. */}
      ...
      {/* Tabbed content — the two tall, lower-frequency panels (Activity,
          Chat) live behind tabs so the Overview tab stays a single scannable
          screen. */}
      <Tabs defaultValue="overview">
        ...
        >
          ...
          <OrderChatPanel orderId={order.id} revalidate={mutate} defaultOpen />
        </TabsContent>
      </Tabs>
    </div>
  );
